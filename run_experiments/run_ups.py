...
def run_experiments(args, save_dir):
    ...
    filename = os.path.join(
        save_dir,
        f'{out_file}_{pseudo_labeller.algorithm_name}_{dataset_name}_M_{num_XGB_models}_numIters_{numIters}_numTrials_{numTrials}_up_thresh_{upper_threshold}_low_thresh_{lower_threshold}.pkl',
    )
